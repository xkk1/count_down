...
use_saying = True # 是否显示名言
saying_font = ('宋体', 16) # 名言的字体及字号
saying_background = "#ff0001"  # 名言背景色
saying_foreground = "#ff0000"  # 名言前景色（文字颜色）

use_img = False # 是否使用图片背景
img_background = "#ff0001"  # 背景图片背景
...
def show_error():
    info = f"""很抱歉，倒计时程序出BUG了，请您把这个错误信息导出发给我，我会把它变得更好
联系方式：
  邮箱：3434623263@qq.com  
  QQ：3434623263 
...
错误信息：
{format_exc()}"""
    show_information(information=info ,title=f"倒计时{version}错误信息{time.strftime('%Y-%m-%d', time.localtime())}")
